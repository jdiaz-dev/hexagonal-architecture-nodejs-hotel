...
export class ProductSaledController {
    ...
    updateProductSaledPayed = async (req:Request, res:Response) => {
        ...
        const productSaled = await this.finishPaymentProductSaledUseCase.finishPaymentProductSaled( parseInt(productSaledId) )
