...
@Service()
export class CreateSaleReportService implements CreateSaleReportUseCase, GetSaleReportForHoustingReportDomain {
    //other domains
    ...
    async createTheSaleReport(houstingId: number): Promise<any> {
        const moneySetProducts: MoneySpentDomainEntity | any = await this.getProductSalesToSaleReportDomain.getProductSalesToSaleReportDomain(houstingId)
