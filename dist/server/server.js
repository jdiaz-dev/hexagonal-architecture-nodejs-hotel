...
const users_routes_1 = __importDefault(require("../JDiazDevHotels/managament/users/users/adapter/in/users.routes"));
const product_routes_1 = __importDefault(require("../JDiazDevHotels/sales/products/adapter/in/web/product.routes"));
const product_sale_routes_1 = __importDefault(require("../JDiazDevHotels/sales/product-sales/adapter/in/web/product-sale.routes"));
const client_routes_1 = __importDefault(require("../JDiazDevHotels/clients/adapter/in/web/client.routes"));
const roles_routes_1 = __importDefault(require("../JDiazDevHotels/managament/users/roles/adapter/in/roles.routes"));
const hotel_routes_1 = __importDefault(require("../JDiazDevHotels/managament/hotels/adapters/in/web/hotel.routes"));
