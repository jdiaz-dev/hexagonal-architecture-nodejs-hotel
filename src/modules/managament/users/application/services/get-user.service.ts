...
import { CommonNeedUserFromUserBcontextPort } from '../../../../../shared/ports/out/common-need-user-from-user-bcontext.port';
...
@Service()
export class GetUserService implements CommonNeedUserFromUserBcontextPort, HotelBcontextNeedUserFromUserBcontext {
